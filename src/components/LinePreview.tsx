      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-sm border border-gray-100 dark:border-slate-800 p-8 transition-colors">
         ...
         <div className="bg-[#8b9db9] rounded-2xl overflow-hidden shadow-inner p-4 relative min-h-[400px]">
             ...
             <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-white text-xs font-bold">SangkhaLab BOT</span>
             </div>
             ...
             <div className="bg-white dark:bg-slate-900 rounded-2xl p-4 sm:p-5 shadow-lg relative overflow-hidden transition-colors">
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3 mb-4 border-b border-slate-100 dark:border-slate-800 pb-3">
                   ...
                   <div className="flex flex-wrap items-center sm:items-end gap-1.5 sm:gap-0.5 text-right shrink-0">
                      ...
                      <span className="text-[9px] sm:text-[10px] text-gray-500 dark:text-gray-400 flex items-center gap-0.5 min-[360px]:ml-2 sm:ml-0 sm:mt-1 font-semibold">🗓 04 พ.ค. 2026</span>
                      <span className="text-[9px] sm:text-[10px] text-gray-500 dark:text-gray-400 flex items-center gap-0.5 min-[360px]:ml-2 sm:ml-0 font-semibold">🕒 23:29</span>
                   </div>
                </div>

                <div className="bg-[#F0F6FC] dark:bg-slate-800/80 rounded-xl p-3 sm:p-4 mb-4 border border-blue-50/50 dark:border-slate-750 transition-colors">
                ...
                <div className="grid grid-cols-2 gap-2 sm:gap-3">
                   <button className="bg-[#06c755] text-white py-2 sm:py-2.5 px-2 rounded-xl text-[10px] min-[360px]:text-xs sm:text-sm font-bold flex items-center justify-center gap-1.5 hover:opacity-90 transition-all shrink-0">
                       <Check size={12} className="sm:w-3.5 sm:h-3.5" /> รับทั้งหมด
                   </button>
                   <button className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 text-gray-600 dark:text-gray-400 py-2 sm:py-2.5 px-2 rounded-xl text-[10px] min-[360px]:text-xs sm:text-sm font-bold flex items-center justify-center gap-1.5 hover:bg-gray-50 dark:hover:bg-slate-700 transition-all shrink-0">
